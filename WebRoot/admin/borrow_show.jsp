...
<tr>
	<th>读者ID</th><th>实体书编号</th><th>借阅日期</th><th>应归还日期</th><th>续借状态</th><th>逾期</th><th>实际归还日期</th><th>修改</th>
</tr>
<%
...
%>
		...
		<tr>
		<td align="center"><%=borrow.getUserid()%></td>
		<td align="center"><%=borrow.getBookID()%></td>
		<td align="center"><%=borrow.getBorrowingtime()%></td>
		<td align="center"><%=borrow.getReturntime()%></td>
		<td align="center"><%=borrow.isRenewstatus()%></td>
		<td align="center"><%=borrow.isReturnstatus()%></td>
		<td align="center"><%=borrow.getTime()%></td>
		<td align="center"><a href="${pageContext.request.contextPath}/admin/readyUpdateBorrow.do?bookID=<%=borrow.getBookID()%>">修改</a></td>
		<td><input type="button" value="返回 " onclick="window.location.href='${pageContext.request.contextPath}/admin/return.do'"/></td>
	<%}
	}%>
	</tr>
</table>
