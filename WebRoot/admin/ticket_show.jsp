...
<tr>
	<th>罚单编号</th><th>罚单类型</th><th>用户ID</th><th>罚单金额</th><th>详情</th><th>是否罚款</th><th>修改</th>
</tr>
<%
...
%>
		...
		<tr>
		<td align="center"><%=ticket.getFineid()%></td>
		<td align="center"><%=ticket.getFinetypeid()%></td>
		<td align="center"><%=ticket.getUserid()%></td>
		<td align="center"><%=ticket.getTotalfineprice()%></td>
		<td align="center"><%=ticket.getFinedetail()%></td>
		<td align="center"><%=ticket.isSettlestatus()%></td>
		<td align="center"><a href="${pageContext.request.contextPath}/admin/readyUpdateTicket.do?fineID=<%=ticket.getFineid()%>">修改</a></td>
