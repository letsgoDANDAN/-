...
<br> <br> <br>
<hr>
 <h3 align="center"><font color="green">请使用微信支付：</h3>
 <h1 align="center"><img src="img/二维码.jpg"></h1>
 <%String fineid=request.getParameter("fineid"); %>
 <h3 align="center"><button onclick="window.location.href='${pageContext.request.contextPath}/payFine.do?fineid=<%=fineid%>'">支付成功！</button></h5>
 </div>
